...
app.use(cors({
  origin: 'http://emission-red.vercel.app',
  credentials: true,
...
app.use('/uploads', (req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'http://emission-red.vercel.app');
...
app.post('/send-reset-email', async (req, res) => {
  ...
  connection.query(query, [email], (err, results) => {
      ...
      const resetLink = `http://emission-red.vercel.app/reset-password?token=${resetToken}`;
      const mailOptions = {
