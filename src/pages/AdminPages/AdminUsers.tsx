...
const AdminUsers: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      try {
        ...
        const response = await fetch('https://emissionserver.vercel.app/all_users', {
          headers: {
    ...
    const fetchOptions = async () => {
      try {
        ...
        const [cpuResponse, gpuResponse, ramResponse] = await Promise.all([
          axios.get(`https://emissionserver.vercel.app/${cpuEndpoint}`),
          axios.get(`https://emissionserver.vercel.app/${gpuEndpoint}`),
          axios.get('https://emissionserver.vercel.app/ram-options'),
        ]);
  ...
  const handleSubmit = async (values: typeof form.values) => {
    try {
      ...
      const response = await fetch('https://emissionserver.vercel.app/register', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
  ...
  const handleDeleteUser = async (userId: string) => {
    try {
      ...
      const response = await fetch(`https://emissionserver.vercel.app/delete_user/${userId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
