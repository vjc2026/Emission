...
const AdminProjectRequests: React.FC = () => {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://emissionserver.vercel.app/admin/project-requests/${selectedRequest.id}/approve`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://emissionserver.vercel.app/admin/project-requests/${selectedRequest.id}/reject`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
