...
export function HELPComponent() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await fetch('https://node-iota-livid.vercel.app/checkDeviceType', {
          method: 'GET',
        ...
        const endpoint = deviceType === 'Laptop'
          ? 'https://node-iota-livid.vercel.app/displayuserM'
          : 'https://node-iota-livid.vercel.app/displayuser';
    ...
    const fetchUserProjects = async (_email: string) => {
      const token = localStorage.getItem('token');
      try {
        const response = await fetch('https://node-iota-livid.vercel.app/profile_display_projects', {
          method: 'GET',
          headers: { 'Authorization': `Bearer ${token}` },
        });
  ...
  useEffect(() => {
    const fetchDevices = async () => {
      const token = localStorage.getItem('token');
      try {
        const response = await fetch('https://node-iota-livid.vercel.app/user_devices', {
          method: 'GET',
          headers: { 'Authorization': `Bearer ${token}` },
        });
  ...
  const handleAddDevice = async () => {
    try {
      ...
      const response = await axios.post('https://node-iota-livid.vercel.app/addDevice', formData, {
        headers: {
  ...
  const handleDeviceSwitch = async (deviceId: number) => {
    const token = localStorage.getItem('token');
    try {
      const response = await fetch('https://node-iota-livid.vercel.app/setCurrentDevice', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
      ...
      if (response.ok) {
        ...
        const deviceTypeResponse = await fetch('https://node-iota-livid.vercel.app/checkDeviceType', {
          method: 'GET',
          headers: { 'Authorization': `Bearer ${token}` },
        });
          ...
          <Stack gap="lg">
            ...
            <Button
              ...
              onClick={async () => {
                const token = localStorage.getItem('token');
                try {
                  const response = await fetch(`https://node-iota-livid.vercel.app/archive_project/${selectedProject.id}`, {
                    method: 'PUT',
                    headers: { Authorization: `Bearer ${token}` },
                  });
                  if (response.ok) {
