import {
  ...
  const LoginPage: React.FC = () => {
    ...
    const handleLogin = async () => {
      try {
        const response = await fetch('https://emissionserver.vercel.app/login', {
          method: 'POST',
          headers: {
    ...
    const handleAdminLogin = async () => {
      try {
        const response = await fetch('https://emissionserver.vercel.app/admin_login', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    const refreshToken = async () => {
      try {
        ...
        const response = await fetch('https://emissionserver.vercel.app/refresh-token', {
          method: 'POST',
          headers: {
